...
const MODEL_ID_DRAGON_SHIN_RIGHT = 9;
const MODEL_ID_DRAGON_SHIN_LEFT = 10;
const MODEL_ID_DRAGON_WING_1_RIGHT = 11;
const MODEL_ID_DRAGON_WING_1_LEFT = 12;
const MODEL_ID_DRAGON_WING_2_RIGHT = 13;
const MODEL_ID_DRAGON_WING_2_LEFT = 14;
const MODEL_ID_DRAGON_WING_3_RIGHT = 15;
const MODEL_ID_DRAGON_WING_3_LEFT = 16;
